...
simPath = '/pub0/oclayton/reflect_multimodal/main/thor_tasks'
for root1, dirs1, files1 in os.walk(simPath):
    for dir1 in dirs1:
      for root2, dirs2, files2 in os.walk(simPath+'/'+dir1):
        for dir2 in dirs2: 
                pathToTasks = os.path.join(root2, dir2)
                with open(f'{pathToTasks}/task.json') as f:
